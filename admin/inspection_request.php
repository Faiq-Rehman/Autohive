...
if (isset($_GET['delete'])) {
    ...
    $del_stmt = $conn->prepare("DELETE FROM inspection_requests WHERE id = ?");
    $del_stmt->bind_param("i", $delete_id);
    $del_stmt->execute();
    header("Location: inspection_request.php"); // Refresh after delete
    exit();
}

// ✅ Fetch inspection requests
$query = "SELECT * FROM inspection_requests ORDER BY created_at DESC";
...
<head>
  <meta charset="UTF-8">
  <title>Admin - Inspection Requests</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="css/inspection_request.css">
</head>
<body>
...
<div class="main-content">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold text-center mb-4">Manage Inspection Requests</h3>
    ...
    <?php else: ?>
      <div class="text-center text-muted">No inspection requests yet.</div>
    <?php endif; ?>
